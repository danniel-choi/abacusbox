...
export const hubContents: Record<HubKey, HubContent> = {
  ...
  business: {
    ...
    description: "부가세, 판매수익, 애드센스·유튜브 광고 수익, 손익분기점, 구독 매출, 물류비처럼 소규모 사업자가 자주 보는 숫자를 정리했습니다.",
    featuredSlugs: ["vat", "seller-profit", "adsense-revenue", "youtube-ad-revenue", "break-even", "subscription-revenue"],
